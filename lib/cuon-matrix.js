...
/**
 * Matrix4的构造器。
 * 如果Matrix4实例被传递到opt_src，则新生成的矩阵被复制并初始化。
 * 否则，初始化为单位矩阵。
 * @param opt_src 要复制元素的矩阵（可选）
 */
...
/**
* 正射影行列に設定する。
* @param left 左剪辑平面的X坐标
* @param right 右クリップ平面のX座標
* @param bottom 下クリップ平面のY座標
* @param top 上クリップ平面のY座標
* @param near 到近剪辑平面的距离。平面位于视点后方的情况下为负数
* @param far 到远剪辑平面的距离。平面位于视点后方的情况下为负数
* @return this
*/
...
/**
* 从右侧放射线矩阵。
* @param left 近剪辑平面上的左剪辑平面的X坐标
* @param right 近クリップ平面上における右クリップ平面のX座標
* @param bottom 近クリップ平面上における下クリップ平面のY座標
* @param top 近クリップ平面上における上クリップ平面のY座標
* @param near 近クリップ平面までの距離。正数でなくてはならない
* @param far 到远剪辑平面的距离。必须是正数
* @return this
*/
...
* 指定视场角和纵横比来设置透视射影矩阵。
* @param fovy 垂直視野角 [度]
* @param aspect 视野宽高比（宽度/高度）
* @param near 到近剪辑平面的距离。必须是正数
* @param far 到远剪辑平面的距离。必须是正数
* @return this
*/
...
/**
* 设置视野转换矩阵。
* @param eyeX, eyeY, eyeZ 视点位置
* @param centerX, centerY, centerZ 目标点位置
* @param upX, upY, upZ 表示相机上方向的方向矢量
* @return this
*/
...
/**
* 通过平行光源将顶点从右侧投影到平面上的行列。
* @param normX, normY, normZ 平面法线矢量(无需正规化)
* @param planeX, planeY, planeZ 平面上の点
* @param lightX, lightY, lightZ 灯光方向（无需规范）
* @return this
*/
